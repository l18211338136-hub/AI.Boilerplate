...
using AI.Boilerplate.Client.Maui.Infrastructure.Services;
...
namespace AI.Boilerplate.Client.Maui;
...
public static partial class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        var builder = MauiApp.CreateBuilder();
            ...
            .UseSentry(options =>
            {
                var configuration = new ConfigurationBuilder().AddClientConfigurations(clientEntryAssemblyName: "AI.Boilerplate.Client.Maui").Build();
        ...
        mauiApp.Services.GetRequiredService<PubSubService>()
            .Subscribe(ClientAppMessages.PAGE_DATA_CHANGED, async (args) =>
            {
                ...
                {
                    Application.Current!.Windows.First().Title = title ?? "AI.Boilerplate";
                });
            });
