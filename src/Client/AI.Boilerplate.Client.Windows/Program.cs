...
using AI.Boilerplate.Client.Core.Components;
using Microsoft.AspNetCore.Components.WebView.WindowsForms;
using AI.Boilerplate.Client.Windows.Infrastructure.Services;

namespace AI.Boilerplate.Client.Windows;
...
public partial class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        var configuration = new ConfigurationBuilder()
            .AddClientConfigurations(clientEntryAssemblyName: "AI.Boilerplate.Client.Windows")
        ...
        _ = pubSubService.Subscribe(ClientAppMessages.PAGE_DATA_CHANGED, async args =>
        {
            ...
            {
                form.Text = title ?? "AI.Boilerplate";
            });
        });
