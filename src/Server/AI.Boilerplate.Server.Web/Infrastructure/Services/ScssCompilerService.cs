...
namespace AI.Boilerplate.Server.Web.Infrastructure.Services;
...
public class ScssCompilerService
{
    internal static async Task WatchScssFiles(WebApplication app)
    {
        ...
        var clientCorePath = Path.Combine(Environment.CurrentDirectory, "../../Client/AI.Boilerplate.Client.Core");
        ...
        // but uses ../../Client/AI.Boilerplate.Client.Web:../../Client/AI.Boilerplate.Client.Web instead of .:.,
        ...
        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/AI.Boilerplate.Client.Maui/Components")))
            sassPathsToWatch.Add("../../Client/AI.Boilerplate.Client.Maui/Components:../../Client/AI.Boilerplate.Client.Maui/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/AI.Boilerplate.Client.Windows/Components")))
            sassPathsToWatch.Add("../../Client/AI.Boilerplate.Client.Windows/Components:../../Client/AI.Boilerplate.Client.Windows/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/AI.Boilerplate.Client.Web/Components")))
            sassPathsToWatch.Add("../../Client/AI.Boilerplate.Client.Web/Components:../../Client/AI.Boilerplate.Client.Web/Components");
