using AI.Boilerplate.Server.Web.Infrastructure.Services;
using AI.Boilerplate.Client.Core.Infrastructure.Services.Contracts;

namespace AI.Boilerplate.Server.Web;
...
public static partial class Program
{
    public static async Task Main(string[] args)
    {
        ...
        builder.Configuration.AddClientConfigurations(clientEntryAssemblyName: "AI.Boilerplate.Client.Web");
